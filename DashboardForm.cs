...
namespace HumanitarianProjectManagement.Forms
{
    public partial class DashboardForm : Form
    {
        ...
        private void ApplyLocalization()
        {
            ...
            this.settingsToolStripMenuItem.Text = resources.GetString("Settings");
            this.exitToolStripMenuItem.Text = resources.GetString("Exit");
            ...
            this.lblSectionsTitle.Text = resources.GetString("SectionsTitle");
            this.btnAddSection.Text = resources.GetString("AddSection");
            this.lblModulesTitle.Text = resources.GetString("ModulesTitle");
        }
